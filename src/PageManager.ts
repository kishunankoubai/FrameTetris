class PageManager implements MyEventListener {
    ...
    readonly eventClassNames: string[] = ["pageIsReady", "pageChanged", "setPage", "backPages", "pageBecomeValid", "pageBecomeInvalid"];
    ...
    //すべてのページの表示状態を設定する
    private async setPages(pageIds: string[]) {
        // 新しいページを取得
