...
class EventManager {
    ...
    static addEvent({ id, handler, classNames = [] }) {
        if (id) {
     ...
     */
    static removeEventsByClassName(className) {
     ...
     * @returns idが登録されているか
     */
    static hasAlreadyAdded(eventId) {
     ...
     */
    static executeEventsByClassName(className) {
        this.eventList
     ...
     */
    static executeListeningEvents(className, eventIds) {
        this.eventList
